...
print('\nWORD COUNT AFTER PUNCTUATION REMOVAL')
print(word_count)
word_count = [''.join(char for char in word if char not in string.punctuation) for word in word_list]
print('\nWORD COUNT AFTER CHARACTER PUNCTUATION REMOVAL')
print(word_count)

# Clean Stop Words
stop_words = ["and", "with", "using", "##", "working", "in", "to"]
_word_count = [word for word in word_count if word not in stop_words]
